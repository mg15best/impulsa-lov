...
export function EventAttendanceManager({ eventoId, eventoNombre }: EventAttendanceManagerProps) {
  ...
  const { data: attendances, loading, reload } = useDataLoader<EventAttendance>(
    "event_attendance",
      ...
      <CardHeader>
        <div className="flex items-center justify-between">
          <div>
            ...
            <CardDescription>
              {attendances.filter(a => a.status === 'attended').length} de {attendances.length} asistentes confirmados
            </CardDescription>
          </div>
          <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
            ...
            <DialogContent className="sm:max-w-[500px]">
              <DialogHeader>
                ...
                <DialogDescription>
                  Añadir un nuevo asistente al evento
                </DialogDescription>
              </DialogHeader>
